...
"tpc,Mod_LSft,Mod_LSft,Num_9zzz","dft,Ltr_Gzzz","dft,Ltr_Xzzz","dft,Ltr_Czzz","dft,Ltr_Vzzz","dft,Sym_FSla","sst,_",                "dft,Fun_Home","dft,Fun_PgDn","dft,Fun_Bksp","dft,Ltr_Bzzz","dft,Ltr_Jzzz","dft,Ltr_Mzzz","dft,Sym_Coma","dft,Sym_Perd","tpc,Mod_RSft,Mod_RSft,Num_0zzz",
...
"transparent",                   "transparent", "transparent", WORKUSER,      "transparent", WORKADMIN,     "transparent",          "transparent", "transparent", "transparent", "transparent", "dft,Num_0zzz","transparent", "transparent", "transparent", "transparent", 
];

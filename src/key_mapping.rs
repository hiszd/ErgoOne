...
pub fn FancyAlice66() -> KeyMatrix<5, 16> {
    KeyMatrix::new([
        ...
        [df!(Mod_LCtl), df!(Ltr_Azzz), df!(Ltr_Szzz), df!(Ltr_Ezzz), df!(Ltr_Rzzz), df!(Ltr_Tzzz), df!(EEEEEEEE), df!(Fun_Spcz), df!(Fun_Entz), df!(EEEEEEEE), df!(Ltr_Hzzz), df!(Ltr_Nzzz), df!(Ltr_Izzz), df!(Ltr_Ozzz), df!(Ltr_Lzzz), df!(Sym_SQut)],

...
impl KeyCode {
  ...
  pub fn from_char(val: char) -> ([Option<KeyCode>; 2], usize) {
    match val {
      'a' => ([Some(KeyCode::Ltr_Azzz), None], 1),
      'A' => ([Some(KeyCode::Ltr_Azzz), None], 1),
      'b' => ([Some(KeyCode::Ltr_Bzzz), None], 1),
      'B' => ([Some(KeyCode::Ltr_Bzzz), None], 1),
      'c' => ([Some(KeyCode::Ltr_Czzz), None], 1),
      'C' => ([Some(KeyCode::Ltr_Czzz), None], 1),
      'd' => ([Some(KeyCode::Ltr_Dzzz), None], 1),
      'D' => ([Some(KeyCode::Ltr_Dzzz), None], 1),
      'e' => ([Some(KeyCode::Ltr_Ezzz), None], 1),
      'E' => ([Some(KeyCode::Ltr_Ezzz), None], 1),
      'f' => ([Some(KeyCode::Ltr_Fzzz), None], 1),
      'F' => ([Some(KeyCode::Ltr_Fzzz), None], 1),
      'g' => ([Some(KeyCode::Ltr_Gzzz), None], 1),
      'G' => ([Some(KeyCode::Ltr_Gzzz), None], 1),
      'h' => ([Some(KeyCode::Ltr_Hzzz), None], 1),
      'H' => ([Some(KeyCode::Ltr_Hzzz), None], 1),
      'i' => ([Some(KeyCode::Ltr_Izzz), None], 1),
      'I' => ([Some(KeyCode::Ltr_Izzz), None], 1),
      'j' => ([Some(KeyCode::Ltr_Jzzz), None], 1),
      'J' => ([Some(KeyCode::Ltr_Jzzz), None], 1),
      'k' => ([Some(KeyCode::Ltr_Kzzz), None], 1),
      'K' => ([Some(KeyCode::Ltr_Kzzz), None], 1),
      'l' => ([Some(KeyCode::Ltr_Lzzz), None], 1),
      'L' => ([Some(KeyCode::Ltr_Lzzz), None], 1),
      'm' => ([Some(KeyCode::Ltr_Mzzz), None], 1),
      'M' => ([Some(KeyCode::Ltr_Mzzz), None], 1),
      'n' => ([Some(KeyCode::Ltr_Nzzz), None], 1),
      'N' => ([Some(KeyCode::Ltr_Nzzz), None], 1),
      'o' => ([Some(KeyCode::Ltr_Ozzz), None], 1),
      'O' => ([Some(KeyCode::Ltr_Ozzz), None], 1),
      'p' => ([Some(KeyCode::Ltr_Pzzz), None], 1),
      'P' => ([Some(KeyCode::Ltr_Pzzz), None], 1),
      'q' => ([Some(KeyCode::Ltr_Qzzz), None], 1),
      'Q' => ([Some(KeyCode::Ltr_Qzzz), None], 1),
      'r' => ([Some(KeyCode::Ltr_Rzzz), None], 1),
      'R' => ([Some(KeyCode::Ltr_Rzzz), None], 1),
      's' => ([Some(KeyCode::Ltr_Szzz), None], 1),
      'S' => ([Some(KeyCode::Ltr_Szzz), None], 1),
      't' => ([Some(KeyCode::Ltr_Tzzz), None], 1),
      'T' => ([Some(KeyCode::Ltr_Tzzz), None], 1),
      'u' => ([Some(KeyCode::Ltr_Uzzz), None], 1),
      'U' => ([Some(KeyCode::Ltr_Uzzz), None], 1),
      'v' => ([Some(KeyCode::Ltr_Vzzz), None], 1),
      'V' => ([Some(KeyCode::Ltr_Vzzz), None], 1),
      'w' => ([Some(KeyCode::Ltr_Wzzz), None], 1),
      'W' => ([Some(KeyCode::Ltr_Wzzz), None], 1),
      'x' => ([Some(KeyCode::Ltr_Xzzz), None], 1),
      'X' => ([Some(KeyCode::Ltr_Xzzz), None], 1),
      'y' => ([Some(KeyCode::Ltr_Yzzz), None], 1),
      'Y' => ([Some(KeyCode::Ltr_Yzzz), None], 1),
      'z' => ([Some(KeyCode::Ltr_Zzzz), None], 1),
      'Z' => ([Some(KeyCode::Ltr_Zzzz), None], 1),
      '1' => ([Some(KeyCode::Num_1zzz), None], 1),
      '2' => ([Some(KeyCode::Num_2zzz), None], 1),
      '3' => ([Some(KeyCode::Num_3zzz), None], 1),
      '4' => ([Some(KeyCode::Num_4zzz), None], 1),
      '5' => ([Some(KeyCode::Num_5zzz), None], 1),
      '6' => ([Some(KeyCode::Num_6zzz), None], 1),
      '7' => ([Some(KeyCode::Num_7zzz), None], 1),
      '8' => ([Some(KeyCode::Num_8zzz), None], 1),
      '9' => ([Some(KeyCode::Num_9zzz), None], 1),
      '0' => ([Some(KeyCode::Num_0zzz), None], 1),
      _ => ([None;2], 0),
    }
  }
}
